...
class SinglyLinkedList
{
  ...
  public:
	...
	void delete_by_data();
	void display();
	SinglyLinkedList<var> operator+(SinglyLinkedList<var> &list);
};
...
*******************************************/
template <typename var>
bool SinglyLinkedList<var>::is_empty()
{
	if (head == NULL)
		return true;
	else
...
*******************************************/
template <typename var>
void SinglyLinkedList<var>::display()
{
	cout << "\n\t";
	if (is_empty())
...
*******************************************/
template <typename var>
void SinglyLinkedList<var>::insert_at_end()
{
	temp = new node;
	cout << "\nEnter the node data: ";
	cin >> temp->data;
...
****************************************************/
template <typename var>
void SinglyLinkedList<var>::insert_at_begin()
{
	temp = new node;
	cout << "\nEnter the node data: ";
	cin >> temp->data;
...
****************************************************/
template <typename var>
void SinglyLinkedList<var>::insert_at_loc()
{
	if (!is_empty())
	{
		temp = new node;
...
********************************************/
template <typename var>
void SinglyLinkedList<var>::delete_at_end()
{
	if (!is_empty())
	{
		if (head == tail)
...
***************************************************/
template <typename var>
void SinglyLinkedList<var>::delete_at_begin()
{
	if (!is_empty())
	{
		if (head == tail)
...
****************************************************/
template <typename var>
void SinglyLinkedList<var>::delete_at_loc()
{
	if (!is_empty())
	{
		int loc;
...
********************************************************/
template <typename var>
void SinglyLinkedList<var>::delete_by_data()
{
	if (!is_empty())
	{
		var data;
...
*******************************************/
template <typename var>
int SinglyLinkedList<var>::count()
{
	int count = 0;
	ptr = head;
	while (ptr != NULL)
...
*******************************************/
template <typename var>
void SinglyLinkedList<var>::search()
{
	if (!is_empty())
	{
		var data;
...
*******************************************/
template <typename var>
void SinglyLinkedList<var>::reverse()
{
	if (!is_empty())
	{
		ptr = head->next;
...
*******************************************/
template <typename var>
SinglyLinkedList<var> SinglyLinkedList<var>::operator+(SinglyLinkedList<var> &list)
{
	tail->next = list.head;
	tail = list.tail;
	cout << "\nConcatenated list:\n";
